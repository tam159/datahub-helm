...
upstream_table_1 = UpstreamClass(
    dataset=builder.make_dataset_urn(platform="trino", name="hive.gfg_data_curated.zalora_orders", env="PROD"),
...
lineage_mcp = MetadataChangeProposalWrapper(
    ...
    entityUrn=builder.make_dataset_urn(platform="trino", name="hive.gfg_data_curated.zalora_items", env="PROD"),
